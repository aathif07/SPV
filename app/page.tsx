...
export default function Home() {
  return <main>
    ...
    <section className="gallery-section" id="gallery"><div className="gallery-head"><SectionHead label="Media & Gallery" title="Moments of Leadership" /><p>Public moments from across his political journey, community engagement and party programmes.</p></div><div className="gallery-grid"><figure className="gallery-tall gallery-cutout"><span aria-hidden="true">LEADERSHIP</span><Image className="gallery-emblem" src="/images/aiadmk-emblem-transparent.png" alt="AIADMK two leaves emblem" width={1254} height={1254} /><Image className="gallery-cutout-photo" src="/images/sp-velumani-namaste-cutout.png" alt="S. P. Velumani greeting with folded hands" fill sizes="(max-width: 800px) 100vw, 50vw" /></figure><figure><Image src="/images/sp-velumani-commons.jpg" alt="S. P. Velumani greeting with folded hands" fill sizes="(max-width: 800px) 50vw, 25vw" /></figure><figure><Image src="/images/sp-velumani-public-meeting.jpg" alt="S. P. Velumani at a public engagement" fill sizes="(max-width: 800px) 50vw, 25vw" /></figure></div><div className="gallery-categories"><h3>Gallery Categories</h3>{["Political Events","Public Meetings","People's Interactions","Government Activities","Constituency Visits","Party Programmes","Social & Community Events","Speeches","Media Interviews"].map(x=><span key={x}>{x}</span>)}</div><p className="media-note">Selected photography sourced from publicly accessible media and Wikimedia Commons. Images remain credited to their respective publishers and creators.</p></section>
