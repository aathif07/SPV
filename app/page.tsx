...
export default function Home() {
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-copy">
      ...
      <div className="hero-intro"><div><strong className="hero-name"><span>S. P. Velumani</span></strong><p>Senior Leader, All India Anna Dravida Munnetra Kazhagam (AIADMK)<br />Member of the Tamil Nadu Legislative Assembly</p></div><p>A leader with extensive political and administrative experience, S. P. Velumani has dedicated his public life to serving the people and contributing to the development of Tamil Nadu.</p></div>
